                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="needs-validation" method="post" action="{{route('update-party', $parties->id)}}">
                                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <select name="party_type" class="form-control border-bottom"
                                                        ...
                                                        <option value="Client" @if($parties->party_type == 'client') {{'selected'}} @endif>Client</option>
                                                        <option value="Vendor" @if($parties->party_type == 'vendor') {{'selected'}} @endif>Vendor</option>
                                                        <option value="Employee" @if($parties->party_type == 'employee') {{'selected'}} @endif>Employee</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="name" value="{{$parties->name}}" type="text" class="form-control border-bottom "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="phone" value="{{$parties->phone}}" type="text" class="form-control border-bottom "
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="address" value="{{$parties->address}}" type="text" class="form-control border-bottom "
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="account_holder" value="{{$parties->account_holder}}" type="text" class="form-control border-bottom "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="account_number" value="{{$parties->account_number}}" type="text" class="form-control border-bottom "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="bank" value="{{$parties->bank}}" type="text" class="form-control border-bottom "
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="bank_ifse" value="{{$parties->bank_ifse}}" type="text" class="form-control border-bottom "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="bank_zip" value="{{$parties->bank_zip}}" type="text" class="form-control border-bottom "
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input name="bank_state" value="{{$parties->bank_state}}" type="text" class="form-control border-bottom "
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <input name="bank_branch" value="{{$parties->bank_branch}}" type="text" class="form-control border-bottom "
